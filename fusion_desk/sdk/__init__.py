"""Fusion-Desk SDK — async HTTP client + local fallback."""
...
class FusionDeskSDK:
    """SDK entry — programmatic access to fusion-desk."""
    ...
    def _ensure_node_modules(cls) -> None:
        if cls._node_modules_loaded:
            return
        import fusion_desk.nodes.macos  # noqa: F401 — trigger registration
        ...
        import fusion_desk.nodes.browser  # noqa: F401
