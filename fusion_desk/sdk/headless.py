...
Importer: test_m5.py (from fusion_desk.sdk.headless import HeadlessRunner).
...
class HeadlessRunner:
    ...
    def __init__(self, engine=None, template_manager=None):
        if engine is None:
            from fusion_desk.engine import WorkflowEngine
    ...
    async def run_template(self, template_id: str, params: dict = None) -> Dict[str, Any]:
        ...
        from fusion_desk.engine import Workflow
